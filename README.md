...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-x13binary-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10752&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-x13binary-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `r-x13binary` available on your platform with:
